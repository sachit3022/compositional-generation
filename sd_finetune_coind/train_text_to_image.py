...
def main():
    ...
    if args.dataset_name== "celeba":
        dataset = CelebaDataset(args.train_data_dir, split='train',clip_preprocess=None,accelerator=None)
        dataset = {'train':Dataset.from_generator(dataset,cache_dir=args.cache_dir)}
    elif args.dataset_name== "waterbirds":
        dataset = CUBDataset(root_dir='/research/hal-gaudisac/Diffusion/controllable-generation/',target_name='waterbird_complete95',confounder_names=['forest2water2'],model_type='resnet50',transform='text',split='train')   
        dataset = {'train':Dataset.from_generator(dataset,cache_dir=args.cache_dir)}
